 ...
 */
final class Version20250323184734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sujets DROP icebergName');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sujets ADD icebergName VARCHAR(255) NOT NULL');
    }
}
